defmodule Turbo.HTML.Paginate do
  @moduledoc """
  https://raw.githubusercontent.com/mgwidmann/scrivener_html/master/lib/scrivener/html.ex
  """
  use Phoenix.HTML
  ...
  Paginate
  """
  # @spec turbo_pagination_links(Map.t()) :: any
